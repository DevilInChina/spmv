...
#pragma omp for schedule(static, chunk)
        for (int par_id = 0; par_id < p - 1; par_id++) {
            ...
            } else // normal track for all the other partitions
            {
                ...
                d_partition_descriptor128i = (__m128i *) &d_partition_descriptor[par_id * ANONYMOUSLIB_CSR5_OMEGA *
                                                                                 num_packet];
                    ...
                    if (!store_to_offchip) {
                        ...
                        first_sum256d = _mm256_add_pd(
                                _mm256_and_pd(_mm256_castsi256_pd(_mm256_cmpeq_epi64(tmp256i, _mm256_set1_epi64x(0))),
                                              first_sum256d),
                                _mm256_and_pd(_mm256_castsi256_pd(
                                        _mm256_cmpeq_epi64(tmp256i, _mm256_set1_epi64x(0xFFFFFFFFFFFFFFFF))), sum256d));
                ...
                sum256d = _mm256_and_pd(_mm256_castsi256_pd(
                        _mm256_setr_epi64x(0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF,
                                           0x0000000000000000)), sum256d);
                ...
                sum256d = _mm256_sub_pd(
                        _mm256_castsi256_pd(_mm256_permutevar8x32_epi32(_mm256_castpd_si256(sum256d), tmp256i)),
                        sum256d);
